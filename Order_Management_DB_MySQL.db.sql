...
SELECT PC.product_class_desc, PRODUCT.product_id, PRODUCT.product_desc, PRODUCT.product_quantity_avail,
CASE 
...
SELECT ONLINE_CUSTOMER.customer_id, ONLINE_CUSTOMER.customer_fname || ' ' || ONLINE_CUSTOMER.customer_lname as full_name, ADDRESS.city, ADDRESS.pincode, ORDER_HEADER.order_id, PRODUCT_CLASS.product_class_desc,  PRODUCT.product_desc, ORDER_ITEMS.product_quantity * PRODUCT.product_price AS subtotal FROM  ADDRESS
